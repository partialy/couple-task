      ...
      >
        <Card className="glass-panel border-0 rounded-[32px] p-2 sm:p-4">
          <CardHeader className="space-y-2 text-center pb-8 pt-6">
            ...
            <CardTitle className="text-2xl font-bold tracking-tight text-[var(--text-main)]">
              极简管理后台
            </CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="username" className="label">用户名 / 邮箱</Label>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs text-[var(--primary)] font-medium hover:underline transition-colors">
                    忘记密码？
                  </a>
                </div>
                <div className="relative">
              ...
              <Button 
                type="submit" 
                className="w-full btn-primary h-[50px] text-base font-semibold"
                disabled={isLoading}
              >
                {isLoading ? (
                  <motion.div
          ...
          <CardFooter className="flex justify-center pb-8">
            <p className="text-xs text-neutral-400">
              &copy; {new Date().getFullYear()} 现代化管理系统. 保留所有权利.
            </p>
          </CardFooter>
        </Card>
      </motion.div>
