    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50">
          <div 
            className="p-4 flex items-center justify-between border-b border-slate-50 dark:border-slate-700/50 relative cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors"
          ...
          <div 
            className="p-4 flex items-center justify-between relative cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors"
